...
tf.flags.DEFINE_string("train_image_dir", data_dir+"/train2014/",
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", data_dir+"/val2014/",
                       "Validation image directory.")

tf.flags.DEFINE_string("train_captions_file", data_dir+"/annotations/captions_train2014.json",
                       "Training captions JSON file.")
tf.flags.DEFINE_string("val_captions_file", data_dir+"/annotations/captions_val2014.json",
                       "Validation captions JSON file.")

tf.flags.DEFINE_string("output_dir", "./model/", "Output data directory.")
